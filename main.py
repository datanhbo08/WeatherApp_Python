...
#-----------you need weather API key to run
    def get_weather(self):
        ...
        try:
            ...
            match response.status_code:
                ...
                case 502:
                    self.display_error("bad Gate way\n Invalid response from sever")
                case 503:
                    self.display_error("Service unavailable\nSever is down")
                case 504:
                    self.display_error("Gate way Timeout\nNo response from sever")
                case _:
    ...
    def display_weather(self, data):
        ...
        temperature_f = (temperature_k * 9/5) - 459.67 #F temperature
